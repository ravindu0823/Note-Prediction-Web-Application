        ...
        <div className="mx-auto max-w-screen-2xl text-center">
          <div className="grid lg:grid-cols-3">
            ...
            <ul className="flex flex-wrap items-center mb-4 text-sm  lg:mb-0 text-gray-400">
              ...
              <li>
                <a href="/articles" className="mr-4 hover:underline md:mr-6">
                  Articles
                </a>
              </li>
              <li>
            ...
            <form action="#" className="flex w-full max-w-sm lg:ml-auto">
              <div className="relative w-full">
                ...
                <input
                  type="email"
                  id="email"
                  className="block p-3 pl-10 w-full text-sm rounded-l-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
              ...
              <button
                type="submit"
                className="py-3 px-5 text-sm text-center text-white rounded-r-lg border cursor-pointer  border-primary-600 focus:ring-4 bg-primary-600 hover:bg-primary-700 focus:ring-primary-800"
              >
                Subscribe
              </button>
            </form>
