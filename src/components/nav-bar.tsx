    ...
    <Navbar className="p-7" color="transparent" placeholder={true}>
      <div className="relative mx-auto flex items-center text-white font-bold">
        ...
        <div className="flex items-center">
          <Button variant="text" size="lg" color="white" className="mr-2" placeholder={"login"}>
            <span>Log In</span>
          </Button>
          <ProfileMenu />
          <Button variant="text" size="lg" color="white" className="mr-2 bg-light-blue-700 rounded-full ms-7" placeholder={"get started"}>
